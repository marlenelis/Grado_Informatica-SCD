...
int main(int argc, char **argv)
{
	...
	//     y definir la activacion del siguiente ciclo
	     ...
	     //bloquear hasta el siguiente tick
	     clock_nanosleep(CLOCK_MONOTONIC,TIMER_ABSTIME, &activacionTiempo,NULL);

	     //calcular la siguiente activacion sumando activaciónTiempo mas cicloMarco
	     cicloMarco = sumaTiempos(&activacionTiempo, &cicloMarco);
